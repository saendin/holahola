...
//	}
	...
	protected void menuPrint() {
		...
		System.out.println();
		System.out.println("                                  1 대여  | 2 반납  | 0 메인으로"); // role에 따라 구성된 메뉴만 출력
		System.out.println();
		System.out.println("===============================================================================================");
		System.out.println();
	}
...
//		int result = 0;
//		// rental의 재고량
//		int rent = rentalDAO.SelectedAmount(isn);
//		// return량 (반납한 총 량)
//		int turn = returnDAO.SelectAmount(isn);
//		// rent - return 
//		int stock = proDAO.SelectAmount(isn);
//		
//		// 최초 렌트일때
////		if (turn == 0) {
////			stock -= rent;
////		} else {
////			// db 재고(쿼리문으로 db stock재고 불러오기) (proDAO.Selected
////			//전체재고 + 반납 = 전체재고
////			stock -= (rent-turn);
////		}
//		
